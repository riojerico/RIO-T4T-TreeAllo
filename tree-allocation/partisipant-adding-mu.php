...
$no_t4tlahan=mysql_fetch_array(mysql_query("select no_t4tlahan,koordinat from view_t4t_ct where hidup='1' and used='0' and koordinat!='' and id_pohon='$id_pohon[0]' and kd_mu='$mu[0]'"));
$no=$no_t4tlahan[0];
...
$item_qty=mysql_fetch_array(mysql_query("select item_qty from t4t_shipment where bl='$add_bl'"));
$item=$item_qty[0];
// echo "<br>";
                          ...
                          <div class="panel-body">
                              ...
                              <?php
                                 ...
                                 <!-- SUBMIT BUTTON ke adding 2-->
                                  <form  id="form" action="admin.php?4e8fa844acbd97b810cffdfc02042420f45db0716a77763d5d20a1bde892af20" method="post">
                                  <div align="center">
