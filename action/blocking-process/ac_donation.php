...
$no_t4tlahan=mysql_fetch_array(mysql_query("select no_t4tlahan,koordinat from current_tree where used='0' and hidup='1' and id_pohon='$id_pohon[0]' and kd_mu='$mu[0]' and koordinat!='' limit 1"));
$no=$no_t4tlahan[0];
...
for ($i=1; $i <= $tot_wins ; $i++) { 
   ...
   $ns2=$ns[0]+$i;
     ...
     $query_current_tree_update=mysql_query("update current_tree set used='1',bl='$bl',no_shipment='$id_partisipan[0]$date$ns2',time='$time' where used='0' and hidup='1' and id_pohon='$id_pohon[0]' and kd_mu='$mu[0]' and koordinat!='' limit 1");
}
