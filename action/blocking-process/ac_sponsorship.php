...
$wins=$start_w-1;
   $win=$wins+$i;
    ...
    $query_shipment=mysql_query("insert into t4t_shipment values ('','$no_ship','$id_partisipan[0]','$bl','$time','$win','','$time_second','','1','$no_order','$destination','$fee','0','$time','1','$note','','1')");
}
...
while ( $data=mysql_fetch_array($data_lahan)) {
    ...
    $query_htc=mysql_query("insert into t4t_htc values ('','$bl','$destination','$kd_lahan2','$no_lahan2','$geo2','$silvilkultur2[0]','$luas2','$petani2[0]','$desa2[0]','$ta2[0]','$mu2[0]','$jml_pohon2[$i]','','$no_ship','$time')");
