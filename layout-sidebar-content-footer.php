              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <!-- <li><a class="" href="?<?php echo paramEncrypt('hal=with-container-adding-mu')?>">add</a></li>  
                          <li><a class="" href="?<?php echo paramEncrypt('hal=with-container-adding-mu2')?>">add 2</a></li>   -->
